        ...
        <div id="page-wrapper" class="gray-bg">
            <div class="row border-bottom white-bg">
                <nav class="navbar navbar-expand-lg navbar-static-top" role="navigation">
                    ...
                    <a href="#" class="navbar-brand">Menu Log</a>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td><?php echo $c['id_log'] ?></td>
                                                        <td><?php echo $c['user'] . " Melakukan " . $c['aksi'] . " " . $c['kegiatan'] . " berisi " . $c['identifier'] ?> </td>
                                                        <td><?php echo $c['waktu'] ?></td>
                                                        <td>
                                                            <table>
                                                                <tr><button name="submit" value="confirm" type="submit" class="btn m-md-1 bg-danger"><i class="fa fa-trash text-white"><a class="text-white" href="../controller/action_delete_logs.php?id=<?php echo $id ?>"> Delete</a></i></button></tr>
