        ...
        <div id="page-wrapper" class="gray-bg">
            <div class="row border-bottom white-bg">
                <nav class="navbar navbar-expand-lg navbar-static-top" role="navigation">
                    ...
                    <a href="#" class="navbar-brand">Konfirmasi Artikel</a>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                $a = "select * from pending";
                                                $b = $koneksi->query($a);
                                                while ($c = $b->fetch_array()) {
                                                    $id = $c['id_artikel'];
                                                ?>
                                                    <tr>
                                                        <td><?php echo $c['id_artikel'] ?></td>
                                                        <td><?php echo $c['judul'] ?> </td>
                                                        <td><?php echo $c['header'] ?></td>
                                                        <td><?php echo $c['user'] ?></td>
                                                        <td><?php echo $c['tag'] ?></td>
                                                        <td>
                                                            <form action="../controller/pending_controller.php?id=<?php echo $c['id_artikel'] ?>" method="post">
                                                                <table>
                                                                    <tr><button name="submit" value="confirm" type="submit" class="btn m-md-1"><i class="fa fa-check text-navy"></i></button></tr>
