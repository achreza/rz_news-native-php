...
<head>
    ...
    <title>RZ-News | Menu rekap</title>
        ...
        <div id="page-wrapper" class="gray-bg">
            <div class="row border-bottom white-bg">
                <nav class="navbar navbar-expand-lg navbar-static-top" role="navigation">
                    ...
                    <a href="#" class="navbar-brand">Menu Rekap</a>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="input-group-append">
                                                    <button class="btn btn-sm btn-primary" type="button"><a class="text-white bg-primary" href="../controller/action_rekap.php">Rekap Hari ini</a></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $c['upload'] ?></td>
                                                        <td><?php echo $c['komentar'] ?></td>
                                                        <td>
                                                            <form action="../controller/rekap_controller.php?id=<?php echo $c['id'] ?>" method="post">
                                                                <table>
