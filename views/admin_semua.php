        ...
        <div id="page-wrapper" class="gray-bg">
            <div class="row border-bottom white-bg">
                <nav class="navbar navbar-expand-lg navbar-static-top" role="navigation">
                    ...
                    <a href="#" class="navbar-brand">List Artikel</a>
                            ...
                            <div class="ibox ">
                                ...
                                <div class="ibox-content">
                                    ...
                                    function hapus($id)
                                    {
                                        var_dump($id);
                                        include "../controller/koneksi.php";
                                        $sql5 = "DELETE FROM `rznews`.`artikel` WHERE  `id_artikel`= " . $id . "";
                                        $koneksi->query($sql5);
                                    };
                                    ?>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="../controller/admin_controller.php?id=<?php echo $c['id_artikel'] ?>" method="post">
                                                                <table>
