                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="exampleModalLongTitle">Tambah Tags Baru</h5>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                                                                    </button>
                                                                </div>
                                                                <form action="../controller/action_add_tags.php" method="post">
                                                                    <div class="modal-body">
                                                                        <div class="mb-2">
                                                                            <label for="exampleFormControlInput1" class="form-label">Nama Tags</label>
                                                                            <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Isi Nama tags" name="tags">
                                                                        </div>
                                                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td><?php echo $c['id_tags'] ?></td>
                                                        <td><?php echo $c['nama_tags'] ?> </td>
                                                        <td>
                                                            <form action="../controller/crud_tags_controller.php?id=<?php echo $c['id_tags'] ?>" method="post">
                                                                <table>
